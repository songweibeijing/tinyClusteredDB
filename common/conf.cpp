...
#define SET_VALUE(field) do{ \
    ...
    SET_VALUE(tables);
    SET_VALUE(max_queue_num);
    SET_VALUE(work_threads);
    SET_VALUE(tcp_path);
    SET_VALUE(tcp_port);
    SET_VALUE(udp_port);
    SET_VALUE(udp_path);
...
void print_config(config *pconfig)
{
    ...
    cout << "max queue number : " << pconfig->max_queue_num << endl;
    cout << "work threads : " << pconfig->work_threads << endl;
    cout << "tcp port : " << pconfig->tcp_port << endl;
    cout << "udp port : " << pconfig->udp_port << endl;
    cout << "tcp path : " << pconfig->tcp_path << endl;
    cout << "udp path : " << pconfig->udp_path << endl;
    cout << endl;
